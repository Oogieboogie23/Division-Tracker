    ...
    <div class="navbar navbar-default navbar-nav navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src='assets/images/logo.svg' class='pull-left'/> <span
                        class="hidden-sm hidden-xs"><strong class='logo'>AOD</strong> <small>Division Tracker
                            <sup>v2</sup></small></span></a>
            </div>
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a href="member/<?php echo $member->member_id; ?>"><?php echo ucwords($member->forum_name); ?>
                                        <span class="pull-right"><?php echo Member::avatar($member->member_id) ?></span></a>
                                </li>
                                <li class="divider"></li>
                                <li class='disabled'><a href='#'
                                                        disabled>Role: <?php echo getUserRoleName($user->role); ?></a>
                                </li>
                                <li class='divider'></li>
                                ...
                                <li><a href="#" data-toggle="pill" class="logout-btn"><i
                                            class="fa fa-lock pull-right"></i> Logout</a></li>
                            </ul>
                        </li>
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <?php foreach ($tools as $tool) : ?>
                                        ...
                                        <li><a href="<?php echo $tool->tool_path ?>"
                                               class="<?php echo $tool->class . " " . $disabled ?>"><?php echo $tool->tool_name ?></a>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                            </li>
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <?php foreach ($divisions as $division) : ?>
                                    ...
                                    <li class="dropdown-submenu"><a
                                            href='divisions/<?php echo $division->short_name ?>'><?php echo $division->full_name ?></a>
                                        <?php if ((array) count($platoons)): ?>
                                            <ul class="dropdown-menu">
                                                <?php foreach ($platoons as $platoonLink) : ?>
                                                    <li>
                                                        <a href="divisions/<?php echo $division->short_name ?>/platoon/<?php echo $platoonLink->number ?>"><?php echo $platoonLink->name; ?></a>
                                                    </li>
                                                <?php endforeach; ?>
                                            </ul>
                                        <?php endif; ?>
