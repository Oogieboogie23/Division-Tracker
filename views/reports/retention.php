<div class='container'>
    ...
    <div class='page-header'>
        <h2><strong>Reports
                <small>Retention Numbers</small>
            </strong></h2>
    </div>
    <p>This data is based on direct interaction with the tracker. Only recruiting or removals done through the tracker
        will be available for view here.</p>
    <hr/>
            ...
            <div class="col-md-12">
                <div class='panel panel-primary'>
                    ...
                    <div class='panel-body'>
                        ...
                        <?php foreach ($monthlyBreakdown as $day) {
                            array_push($labels, date('m-d', strtotime($day['week_beginning'])));
                        } ?>
                        <?php $data['labels'] = $labels; ?>

                        <?php $datastats = array(); ?>
                        <?php foreach ($monthlyBreakdown as $day) {
                            array_push($datastats, $day['count']);
                        } ?>
            ...
            <div class="col-md-6">
                <div class="panel panel-primary">
                    ...
                    <?php foreach ($recruited as $member): ?>
                        <a href="member/<?php echo $member['member_id'] ?>"
                           class="list-group-item"><?php echo ucfirst($member['forum_name']) ?><span
                                class="pull-right"><?php echo $member['recruited'] ?></span></a>
                    ...
                    <div class="panel-footer text-muted"><strong>Total</strong><span
                            class="pull-right"><?php echo $i ?></span></div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class='panel panel-primary'>
                    ...
                    <div class='panel-body'>
                        ...
                        <?php foreach ($byTheMonth as $day) {
                            array_push($labels, date('F', strtotime($day['month_beginning'])));
                        } ?>
                        <?php $data['labels'] = $labels; ?>
                    ...
                    <div class="panel-footer text-muted">
                        <small>Reflects activity over the past 5 months</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    ...
                    <pre class='well code' id='activity'
                         onClick="$(this).selectText()"><?php echo $activity_bb; ?></pre>
                </div>
            </div>
        </div>
